<template>
    <div class="borad-inner-body">
        <div class="borad-inner-body-con">
            <div class="operator-detail-wrapper" v-if="authData && authData.role_id != 1">
                <div class="operator-detail-tab">
                    <div class="operator-detail-sec add-more-detail">
                        <ul class="nav nav-pills " id="pills-tab" role="tablist">
                            <li @click="getChatFlow(template.id)" v-for="(template, index) in templates" :key="index" class="nav-item" role="presentation">
                                <button class="nav-link" :class="template_id == template.id ? 'active' : ''" id="pills-chat-flow-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-chat-flow" type="button" role="tab"
                                    aria-controls="pills-chat-flow" aria-selected="true">{{ template.template_name
                                    }}</button>
                            </li>
                                                ...
                                                <div
                                                    ...
                                                    <div class="assistant-btn-sec show"
                                                        ...
                                                        <div class="assistant-btn-con">
                                                            <button class="thm-btn" @click="setupForm(1, data)">Add
                                                                Message</button>
                                                            <button class="thm-btn" @click="setupForm(2, data)">Add
                                                                Option</button>
                                                        </div>
                                                        <div>
                    ...
                    <div class="status-popup-sec">
                        <div class="status-popup-con">
                            ...
                            <div class="operator-offcanvas-footer pb-0">
                                <button class="thm-btn thm-border-btn grey-bg border-0" data-bs-dismiss="modal" ref='closeLangBtn'>Back</button>
...
export default {
    ...
    methods: {
        ...
        getChatTemplates() {
            this.$store.commit('is_loader', true);
            axios.post('/chat-flow/get-chat-templates')
                .then(res => {
                    this.$store.commit('is_loader', false);
...
<style scoped>.org-tree-container {
    width: 100%;
    display: flex;
