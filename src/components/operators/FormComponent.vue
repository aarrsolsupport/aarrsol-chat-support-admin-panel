    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="operatoroffcanvas" aria-labelledby="operatoroffcanvasLabel">
        ...
        <div class="offcanvas-body operator-offcanvas-body">
            ...
            <div class="operator-offcanvas-footer">
                <button class="thm-btn thm-border-btn" data-bs-dismiss="offcanvas" aria-label="Close" ref="opCloseBtn" >Close</button>
...
<script>
    ...
    export default {
        ...
        watch: {
            '$store.state.op_edit': function () {
                var e_data = this.$store.state.op_edit
                this.setupOpForm(e_data.form_type, e_data.form_item)
            }
        },
        methods: {
            setupOpForm(type, item) {
                this.v$.$reset();
                this.errorsList = {};
                this.itemForm = type;
                switch(type) {
