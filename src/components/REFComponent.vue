...
<script>
   ...
   export default {
      ...
      methods: {
        ...
        getChatWindow() {
            axios.post('/chat-support/get-data', { ref_id: 'opwl11', user_id: 'RMOAWQy3Gf' })
            .then(res => {
                console.log(res)
            }).catch(e => {
                console.error(e);
        ...
        getChatMessages() {
            axios.post('/chat-support/get-chat-messages', { ref_id: 'opwl11', user_id: 'RMOAWQy3Gf', chat_id: "a28fa36f-8a14-3b72-8060-40ddae3caf04" })
            .then(res => {
                console.log(res)
            }).catch(e => {
                console.error(e);
