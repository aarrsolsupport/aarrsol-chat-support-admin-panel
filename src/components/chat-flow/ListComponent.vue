                                ...
                                <div class="add-messag-body" v-if="showForm == 1">
                                    ...
                                    <div class="operator-item">
                                        ...
                                        <textarea type="text" class="form-control" placeholder="Enter Message"
                                            rows="3" v-model="message_data"></textarea>
                                    </div>
                                    <div class="operator-item">
                                        ...
                                        <div id="fileList" class="fileList-con">
                                            <ul v-if="uploaded_files.length">
                                                <li v-for="(file, index) in uploaded_files" :key="index" :id="'n_file'+index">
                                                    {{ file.name }}
                                                    <span class="list-cross" @click="removeFile(index)" ><img src="@/assets/images/cross-icon.svg" alt=""></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="add-messag-body" v-else>
                                    ...
                                    <div class="operator-item">
                                        ...
                                        <div class="title-input">
                                            <input type="text" class="form-control" placeholder="Enter Message" v-model="new_option"/>
                                            <button class="thm-btn thm-border-btn title-input-btn" @click="addOption">Save & Add</button>
                                        </div>
                                        <div id="fileList" class="fileList-con">
                                            <ul v-if="categories_data.length">
                                                <li v-for="(option, index) in categories_data" :key="index">
                                                    {{ option }} 
                                                    <span class="list-cross" @click="removeOption(index)" ><img src="@/assets/images/cross-icon.svg" alt=""></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
